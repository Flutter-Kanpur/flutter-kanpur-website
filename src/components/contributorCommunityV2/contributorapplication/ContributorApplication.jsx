...
const ContributorApplication = ({
 ...
 const CustomDropDownIcon = (props) => (
  <SvgIcon {...props} viewBox="0 0 18 18">
    <image href="/assets/contributionIcons/downArrow.svg" height="100%" width="100%" />
  </SvgIcon>
);

const TriangleErrorIcon = (props) => (
  <SvgIcon {...props} viewBox="0 0 16 15" sx={{ ...props.sx, width: 16, height: 15 }}>
    <image href="/assets/contributionIcons/triangleIcon.svg" height="100%" width="100%" />
  </SvgIcon>
);
...
const DeleteIcon = (props) => (
  ...
  >
    <image 
      href="/assets/contributionIcons/bin.svg" 
      height="100%" 
      width="100%" 
    />
  </SvgIcon>
                  ...
                  endAdornment: formData[field] && (
                    <InputAdornment position="end">
                      <IconButton onClick={() => handleInputChange(field, '')} edge="end">
                        <DeleteIcon sx={{ color: '#FF5252', fontSize: '20px' }} />
                      </IconButton>
                    </InputAdornment>
                  ),
                }}
