...
// Move data fetching into an async function (since top-level await is not allowed in React components/pages)
// Also, Next.js page components should be async if using server-side data fetching
